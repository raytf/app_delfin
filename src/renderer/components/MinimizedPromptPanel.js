...
function StreamingResponseBody({ errorMessage, hasResponseText, isSubmitting, latestResponseText, }) {
    ...
    return (_jsx("div", { className: "min-h-[10rem] flex-1 rounded-2xl border border-[var(--border-soft)] bg-[var(--bg-surface)] p-4 shadow-sm", children: errorMessage !== null ? (_jsx("p", { className: "text-sm leading-6 text-[var(--danger)]", children: errorMessage })) : latestResponseText !== null && latestResponseText.length > 0 ? (_jsx("div", { className: "no-drag flex h-full min-h-0 flex-col", children: _jsx("div", { className: "min-h-0 flex-1 overflow-y-auto text-sm leading-6 text-[var(--text-primary)]", ref: setScrollContainer, children: _jsx("p", { className: "whitespace-pre-wrap", children: latestResponseText }) }) })) : (_jsx("p", { className: "text-sm leading-6 text-[var(--text-muted)]", children: "Ask about what's on screen to get a response here." })) }));
}
