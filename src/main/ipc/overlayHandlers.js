...
export function registerOverlayIpcHandlers(options) {
    ...
    ipcMain.handle(RENDERER_TO_MAIN_CHANNELS.OVERLAY_SET_MINIMIZED_VARIANT, async (_event, variant) => {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Failed to set minimized overlay variant.';
