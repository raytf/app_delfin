...
function getMinimizedBounds(variant) {
...
function getWindowBounds(mode, minimizedVariant) {
...
export function createOverlayWindow(mode, minimizedVariant) {
...
export function setOverlayMode(window, mode, minimizedVariant) {
