...
const MINIMIZED_PROMPT_INPUT_WINDOW_WIDTH = 440;
const MINIMIZED_PROMPT_INPUT_WINDOW_HEIGHT = 148;
const MINIMIZED_PROMPT_RESPONSE_WINDOW_WIDTH = 440;
const MINIMIZED_PROMPT_RESPONSE_WINDOW_HEIGHT = 432;
