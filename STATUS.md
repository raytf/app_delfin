...
> Last updated: 2026-05-04 (Windows LiteRT-LM C++ setup docs expanded with the verified first-build path: Visual Studio 2022 Build Tools + Desktop development with C++, VS Developer shell, `cl.exe` check, Administrator/Developer Mode symlink recovery, and short Bazel output root `C:\b` / `D:\b`).
...
| `native/litert-cpp-bridge/README.md`                                       | ✅     | Bridge developer guide now includes the Windows first-build checklist: Bazelisk, VS 2022 Desktop development with C++, `where.exe cl`, symlink troubleshooting, and short Bazel output-root setup.                                                                  |
