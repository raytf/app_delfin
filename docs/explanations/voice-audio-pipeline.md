...
## Stage 2 — The Backend Processes Audio + Image

The backend receives a WebSocket message shaped like:
...
Tokens stream back as `{"type": "token", "text": "..."}` followed by `{"type": "done"}`.
