...
| [`features/native-windows-backend-research-spec.md`](features/native-windows-backend-research-spec.md)             | 🚧 In Progress | Sequential native Windows backend validation: LiteRT-LM C++ first, Foundry Local only as contingency. Proxy/benchmark groundwork landed; native bridge validation pending. |
